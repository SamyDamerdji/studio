  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        "relative overflow-hidden border border-primary/30 bg-secondary/20 shadow-lg shadow-primary/10 backdrop-blur-lg",
        className
      )}
      {...props}
    >
      <div className="absolute -right-4 -top-4 -z-10 h-24 w-24 bg-[radial-gradient(closest-side,hsl(var(--primary)/0.1),transparent)]" />
      {children}
